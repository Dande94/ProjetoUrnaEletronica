...
function clicou(n){
    ...
    if(elNumero !== null){
        ...
        //nova função apreendida .nextElementSibling que procura o proximo elemento com mesmo nome e ou caracteristicas;
...
/*
versão sem verificação, essa versão aceita digitos e depois clicar em branco, difernete do anterior;
function branco(){
        numero = '';
        votoBranco = true;
        seuVotoPara.style.display = 'block';
...
function confirmar(){
    ...
    if(votoConfirmado){
        ...
        if(etapas[etapaAtual] !== undefined){
            ...
            document.querySelector('.tela').innerHTML = '<div class="pisca avisoGigante">FIM</div>' ;
            console.log(votos);
        }
    }
